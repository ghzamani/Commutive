...
const DashboardSearchPage = (props) => {
  ...
  return (
    <>
      ...
      <ul className="list-group" style={{width: "45vw", zIndex: "10"/* ,display:"fix",marginLeft:"250px"*/}}>
